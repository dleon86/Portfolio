...
def wineLinReg(X_train_nrm, Y_train_nrm, X_test_nrm, Y_test_nrm, X_train_df):
# #%% Linear regression
    ...
    plot_Wine2(X_train_nrm, Y_train_nrm, X_test_nrm, Y_test_nrm, X_train_df, Y_test_nrm_P, banner)
